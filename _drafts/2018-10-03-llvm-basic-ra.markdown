...
Let's do another LLVM exercise, this time we look at implementing a very basic
register allocator inside the LLVM CodeGen framework. Again, the focus is not
to achieve an industrial strength implementation but rather to play around and
get a feel for the different CodeGen APIs and IRs.
